    ...
    $(function() {
        $("#formUser").submit(function() {
            ...
            $.ajax({
                ...
                cache: false,
                contentType: false,
                success: function(criadouser) {
                    if (criadouser.indexOf("USER_CRIADO_RFID") >= 0) {
                        $("#autenticacaoOK").modal("show");
                        $('#usuario').val('');
                        $('#senha').val('');
                        $('#cargo').val('0').change();
                    } else if (criadouser.indexOf("needinsert_rfid") >= 0) {
                        $("#autenticacaoERROR").modal("show");
                    } else if (criadouser.indexOf("USER_CRIADO_NORMAL") >= 0) {
                        $("#autenticacaoOK2").modal("show");
                    }
                }
            })
            return false;
...
<body>
    <div class="modal fade has-shown" id="autenticacaoOK" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="exampleModalCenterLabel" class="modal-title"> Usuário criado com sucesso! </h5>
                </div>
                <div class="modal-body">
                    <p> Usuário criado com sucesso, o código RFID refere-se ao último não cadastrado a nenhum usuário. </p>
                </div>
    ...
    <div class="modal fade has-shown" id="autenticacaoOK2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="exampleModalCenterLabel" class="modal-title"> Usuário criado com sucesso! </h5>
                ...
                <div class="modal-body">
                    <p> Usuário criado com sucesso, o login já está disponível para acesso ao sistema! </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-dismiss="modal">Fechar</button>
                </div>
    ...
    <div class="modal fade has-shown" id="autenticacaoERROR" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="exampleModalCenterLabel" class="modal-title"> Usuário não criado! </h5>
                </div>
                <div class="modal-body">
                    <p> Verifique se o usuário já existe ou não existe código RFID disponível para preenchimento automático. </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-dismiss="modal">Fechar</button>
                </div>
            ...
            <div class="aside-content">
                    ...
                    <div id="dropdown-aside" class="dropdown-aside collapse">
                        <div class="pb-3">
                            <a class="dropdown-item" href="sair.php">
                                <spa n class="dropdown-icon oi oi-account-logout">
                                    </span> Logout</a>
                        </div>
                    </div>
                </header>
                <div class="aside-menu overflow-hidden">
                    <nav id="stacked-menu" class="stacked-menu">
                        <ul class="menu">
                            <li class="menu-item">
                                <a href="dashboard.php" class="menu-link"><span class="menu-icon fas fa-home"></span> <span class="menu-text">Home</span></a>
                            </li>
                            <li class="menu-item has-active">
                                <a href="#" class="menu-link"><span class="menu-icon fas fa-tools"></span> <span class="menu-text">Registro</span></a>
                            </li>
                        </ul>
                    </nav>
                </div>
                    ...
                    <div class="page-inner">
                        <header class="page-title-bar">
                            <div class="d-flex flex-column flex-md-row">
                                <p class="lead">
                                    <span class="font-weight-bold">Caro usuário(a), <?php echo $usuario; ?>!</span> <span class="d-block text-muted">Aqui você realiza o cadastro do acesso ao sistema!</span>
                                </p>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><center>Informações do Novo Usuário</center></h4>
                                    <form name="formUser" id="formUser" method="POST" class="needs-validation" novalidate="">
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="usuario">Usuário:</label>
                                                <input type="text" placeholder="Usuário" name="usuario" class="form-control" id="usuario" required="">
                                                <div class="invalid-feedback"> É necessário um usuário. </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="senha">Senha</label>
                                                <input type="password" name="senha" placeholder="Senha" class="form-control" id="senha" required="">
                                                <div class="invalid-feedback"> É necessário uma senha. </div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="rfidcodigo">Código RFID</label>
                                                <input type="text" name="rfidcodigo" placeholder="Código RFID" class="form-control" id="rfidcodigo">
                                                <div class="invalid-feedback"> É necessário um código de RFID. </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="cargo">Cargo</label>
                                                <select class="custom-select d-block w-100" id="cargo" name="cargo" required="">
                                                    <option value="0"> Escolha um cargo... </option>
                                                    <option value="1"> Administrador </option>
                                                </select>
                                                <div class="invalid-feedback"> Escolha um cargo para o usuário! </div>
                                            </div>
                                        </div>
                                        <hr class="mb-4">
